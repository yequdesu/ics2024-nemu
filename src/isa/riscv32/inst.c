...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (word_t)((int64_t)(int32_t)src1 * (uint64_t)(uint32_t)src2 >> 32));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = (word_t)((uint64_t)(uint32_t)src1 * (uint64_t)(uint32_t)src2 >> 32));
